...
### Example Categories by Data and Label Type :

| Task            | X type  | Tubular                                                                                                                                                                                                                                       | Time-Series                                                                                                          | Image                                                                                                                                                                                                                                                                                                                                                                    | Text                                                                      |
|-----------------|---------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------|
| **Classification** | **Binary**   | [Generate Creditcard Fraud Dataset](examples/ccnet_generate_credit_card_fraud_dataset.ipynb)<br>[Beyond Correlation How Causality Ensures Perfect Airline Customer satisfaction](examples/beyond_correlation_how_causality_ensures_perfect_airline_customer_satisfaction.ipynb) |                                                                                                                      |                                                                                                                                                                                                                                                                                                                                                                           |                                                                           |
|                 | **Multi Class** |                                                                                                                                                                                                                                                | [Gpt performance EEG](examples/ccnet_gpt_performance_eeg.ipynb)<br>[Prediction of mice DNA sequences](examples/ccnet_prediction_of_mice_dna_sequences.ipynb)<br>[Predicting Korean stock prices](examples/predicting_korean_stock_prices_using_ccnet.ipynb) | [Annotated food crops and weed images](examples/Annotated_food_crops_and_weed_images.ipynb)<br>[Encoder to core model using CelebA](examples/ccnet_encoder_to_core_model_using_celebA.ipynb)<br>[Generate your handwritten digits from any number](examples/ccnet_generate_your_handwritten_digits_from_any_number.ipynb)<br>[Transform old painting to real photo](examples/ccnet_transform_old_painting_to_real_photo.ipynb)<br>[let you smile by reshaping gender expressions](examples/let_you_smile_by_reshaping_gender_expressions.ipynb)<br>[Discover your animal match](examples/discover_your_animal_match_with_ccnet.ipynb)<br>[Recycling waste image classification](examples/recycling_waste_image_classification_with_ccnet.ipynb) |                                                                           |
|                 | **Multi Label** |                                                                                                                                                                                                                                                |                                                                                                                      |                                                                                                                                                                                                                                                                                                                                                                           |                                                                           |
| **Regression**      | **Single**     |                                                                                                                                                                                                                                                | [Daily climate prediction](examples/ccnet_daily_climate_prediction.ipynb)<br>[Renewable energy prediction](examples/ccnets_renewable_energy_prediction.ipynb) |                                                                                                                                                                                                                                                                                                                                                                           |                                                                           |
|                 | **Compositional Regression** | [Sparse drug composition prediction from NIR dataset](examples/sparse_drug_composition_prediction_from_NIR_dataset_using_ccnet.ipynb)                                                                                                           |                                                                                                                      |                                                                                                                                                                                                                                                                                                                                                                           |                                                                           |
|                 | **Ordinal Regression**  |                                                                                                                                                                                                                                                |                                                                                                                      |                                                                                                                                                                                                                                                                                                                                                                           | [Using pretrained NLP for Amazon reviews](examples/ccnet_using_pretrained_nlp_for_amazon_reviews.ipynb)                         |
| **Generation**      |         | [Synthesize Creditcard Fraud Dataset](examples/ccnet_synthesize_credit_card_fraud_dataset.ipynb)                                                                                                                                          |                                                                                                                      | [Pick your own Pokemon](examples/ccnet_pick_your_own_pokemon.ipynb)<br>[Celeba encoding CCNet](examples/celeba_encoding_ccnet.ipynb)                                                                                                                                                                                                                      |                                                                           |
