...
def tensorboard_log_train_metrics(tensorboard, iteration: int, ccnet_metric: Optional[Dict]):
    """
    Log training metrics for ccnet type to TensorBoard.
