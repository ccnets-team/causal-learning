...
class CausalEncodingTrainer(TrainerBase):
    ...
    """
    def __init__(self, encoder: Encoder, training_params, algorithm_params, optimization_params, task_type):
        """
        ...
        """        
        TrainerBase.__init__(self, encoder.networks, training_params, algorithm_params, optimization_params, task_type, encoder.device)
